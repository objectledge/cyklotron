 ...
 * @version $Id: CreateComponentTemplate.java,v 1.1 2005-01-24 04:34:04 pablo Exp $
 */
public class CreateComponentTemplate extends BaseAppearanceAction
{
        ...
        throws ProcessingException, NotFoundException
    {
        ...
        try
        {
            ...
            skinService.createComponentTemplate(site, skin,
                compRes.getApplicationName(), compRes.getComponentName(), 
        ...
        {
            data.setView("appearance,skin,CreateComponentTemplate");
        }
        else
        {
