 ...
 * @version $Id: DeleteScreenTemplate.java,v 1.1 2005-01-24 04:34:04 pablo Exp $
 */
public class DeleteScreenTemplate extends BaseAppearanceAction
{
        ...
        throws ProcessingException, NotFoundException
    {
        ...
        try
        {
            skinService.deleteScreenTemplate(getSite(context), skin, screenRes.getApplicationName(),
        ...
        {
            data.setView("appearance,skin,DeletedScreenTemplate");
        }
        else
        {
