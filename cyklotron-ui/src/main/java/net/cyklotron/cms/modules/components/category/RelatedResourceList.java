    ...
    extends BaseResourceList
{
     ...
     * (non-Javadoc)
     * @see
     * net.cyklotron.cms.modules.components.category.BaseResourceList#getCacheKeyNode(net.cyklotron
     * .cms.category.components.BaseResourceListConfiguration, net.cyklotron.cms.CmsData)
     */
