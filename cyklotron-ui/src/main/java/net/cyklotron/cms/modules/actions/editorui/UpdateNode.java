    ...
    extends BaseAddEditNodeAction
{
        ...
        throws ProcessingException
    {
        ...
        try
        {
            ...
            if(structureService.updateNode(coralSession, node, name, updateTimeStamp, subject) && setUnclassified(coralSession, categoryService, node))
            {
    ...
    protected boolean setUnclassified(CoralSession coralSession,CategoryService categoryService, NavigationNodeResource node)
    { 
