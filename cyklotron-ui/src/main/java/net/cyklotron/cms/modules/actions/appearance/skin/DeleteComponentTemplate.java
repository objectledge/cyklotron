 ...
 * @version $Id: DeleteComponentTemplate.java,v 1.1 2005-01-24 04:34:04 pablo Exp $
 */
public class DeleteComponentTemplate extends BaseAppearanceAction
{
        ...
        throws ProcessingException, NotFoundException
    {
        ...
        try
        {
            skinService.deleteComponentTemplate(getSite(context), skin, compRes.getApplicationName(),
        ...
        {
            data.setView("appearance,skin,DeletedComponentTemplate");
        }
        else
        {
