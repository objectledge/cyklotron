    ...
    extends BaseForumScreen
{
    ...
    public EditMessage(org.objectledge.context.Context context, Logger logger,
        ...
        throws ProcessingException
    {
        ...
        try
        {
            ...
            templatingContext.put("transitions",workflowService.getTransitions(coralSession, message.getState()));
        }
