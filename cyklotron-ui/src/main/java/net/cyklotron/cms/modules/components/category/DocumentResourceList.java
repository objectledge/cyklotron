    ...
    extends BaseResourceList
{
    ...
    {
        return new net.cyklotron.cms.category.components.DocumentResourceList(context,
            integrationService, cmsDataFactory, categoryQueryService, siteService, structureService);
    }
}
