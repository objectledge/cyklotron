...
public class FilesProvider {
    ...
    public FilesProvider() {
        PicoContainer container = (PicoContainer)context.getAttribute(LedgeServletContextListener.CONTAINER_CONTEXT_KEY);
        FilesService filesService = (FilesService)container.getComponentInstance(FilesService.class);        
    }
    ...
    public CmsFile getFile(@PathParam("filepath") String filepath, 
        ...
        return this.getFileService().getFile(filepath, filename);
    }
