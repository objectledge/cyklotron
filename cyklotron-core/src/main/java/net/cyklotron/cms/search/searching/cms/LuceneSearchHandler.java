...
public class LuceneSearchHandler
    implements SearchHandler<LuceneSearchHit>
{
        ...
        CoralSession coralSession)
    {
        ...
        TableModel<LuceneSearchHit> model = new HitsTableModel<LuceneSearchHit>(context, hits,
            this, link, subject, authContext.isUserAuthenticated());
        return model;
    }
    ...
    {
        return integrationService.getResourceClass(coralSession, coralSession.getSchema()
            .getResourceClass(hit.getResourceClassId()));
    }
