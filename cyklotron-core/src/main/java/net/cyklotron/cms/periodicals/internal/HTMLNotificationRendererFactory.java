    ...
    implements PeriodicalRendererFactory
{
    ...
    public HTMLNotificationRendererFactory(Logger log, Templating templating, MailSystem mailSystem,
    ...
    {
        return new HTMLNotificationRenderer(log,templating, mailSystem,
